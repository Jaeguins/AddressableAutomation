...
namespace AssetAutomation.Runtime {
    ...
    public class AAOption : ScriptableObject {
        ...
        public static char AssetReferenceDiffKeyword=> Instance._assetReferenceKeyword;
        ...
        public static string MethodCallNestedAlert => Instance._methodNestedAlert;
...
#region Option
        ...
        [SerializeField]
        private char _assetReferenceKeyword = '!';
#endregion
...
#region AAView Localization
        ...
        [SerializeField]
        private string _methodNestedAlert = " : MethodCalling with nested object/AssetReference is not supported.";
